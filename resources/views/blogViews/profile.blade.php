...
<div class="container-fluid bg-light p-5">
    <div class="row">
        ...
        <div class="col-10 px-5">
            <h1 style="color: #bc382e">Profil</h1>
            <div class="row my-5 pb-5">
                <div class="col-4">
                    <img src="https://picsum.photos/250/250" class="rounded-circle">
                </div>
                <div class="col-8 p-5 my-3 rounded-pill" style="border-style: solid; border-width: 1px; border-color: #bc382e">
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col">Ad</th>
            ...
            <h1 style="color: #bc382e">Bloglarım</h1>
