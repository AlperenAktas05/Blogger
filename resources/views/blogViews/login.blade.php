...
<div class="container-fluid p-2 pb-5" style="background-color: #bc382e;">
    ...
    <div class="col-4 offset-4 p-5 bg-light my-5">
        <form action="{{route("routeSubmitLogin")}}" method="post" class="mb-5">
            @csrf
            <h1 class="mb-5">Oturum Açın</h1>
            ...
            <div class="mb-3">
                <a href="" style="color: #bc382e">Parolanızı mı unuttunuz?</a>
            </div>

            <div class="mt-5 text-center">
                <button type="submit" class="btn text-light rounded-0 px-5 py-3 text-center" style="background-color: #bc382e">Oturum Aç</button>
            </div>

            <div class="text-center mt-2">
                <span>Hesabınız yok mu? <a href="{{route("routeSignup")}}" style="color: #bc382e">Hesap Oluştur</a></span>
            </div>
        </form>
    </div>
</div>
